...
def btech1():
    faculty_map_1 = Faculty2()
    time_table_1 = Time_table2()
    unsuccessful = 0
    rows = db.execute("SELECT * FROM offers WHERE batch = 1").fetchall()
    total_lec = 0
    for row in rows:
...
def btech2():
    faculty_map_2 = Faculty2()
    time_table_2 = Time_table2()
    unsuccessful = 0
    rows = db.execute("SELECT * FROM offers WHERE batch = 2").fetchall()
    total_lec = 0
    for row in rows:
...
def btech3():
    faculty_map_3 = Faculty2()
    time_table_3 = Time_table_with_slots2()
    unsuccessful = 0
    rows = db.execute("SELECT user_id,slot FROM slots join offers ON slots.course_id = offers.course_id and batch = 3").fetchall()
    max_lec = 0
    for row in rows:
...
def btech4():
    faculty_map_4 = Faculty2()
    time_table_4 = Time_table_with_slots2()
    unsuccessful = 0
    rows = db.execute("SELECT user_id,slot FROM slots join offers ON slots.course_id = offers.course_id and batch = 4").fetchall()
    max_lec = 0
    for row in rows:
